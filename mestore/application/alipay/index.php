...
<div id="main">
    <div id="tabhead" class="tab-head">
        ...
        <form name="alipayment" action="pagepay/pagepay.php" method="post" >
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDtotal_amount").value = "<?php echo $_GET['total'] ?>";
	}
	GetDateNow();

    // setTimeout("document.alipayment.submit()",100) 
</script>
</html>