...
Page({
  ...
  formSubmit: function(e) {
    ...
    if (e.detail.value.name == "") {
      ...
      flag = true;
      wx.request({
        url: 'https://huazai233.picp.vip/store/order/addAddress?tell=' + e.detail.value.tell + "&door=" + e.detail.value.door + "&name=" + e.detail.value.name + "&area=" + e.detail.value.area + "&door=" + e.detail.value.door + "&id=" + that.data.id,
        header: {
